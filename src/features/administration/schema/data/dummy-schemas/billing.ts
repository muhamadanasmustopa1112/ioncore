...
export const BILLING_SCHEMAS: SchemaRecord[] = [
  {
    ...
    version: "1.2",
    status: "published",
    content: billingResidentialContent,
  ...
  },
  {
    ...
    version: "1.0",
    status: "published",
    content: billingEnterpriseContent,
    change_reason: "Initial release untuk segmen enterprise",
    created_by: "user-001",
    published_by: "user-002",
  ...
  },
  {
    ...
    status: "draft",
    content: {},
    change_reason: "Revisi grace period dan denda keterlambatan",
    created_by: "user-001",
