...
import { useQuotations } from "../../api/get-quotations";
import { useQuotationColumns } from "./quotation-columns";
...
export function QuotationList() {
  ...
  const { data, isLoading, isFetching } = useQuotations(params);

  const rows = useMemo(() => data?.quotations ?? [], [data]);
        ...
        <CardHeader>
          <CardHeading className="py-4">
            <div className="relative">
              ...
              <Input
                placeholder={t("enterprise.cpq.searchQuotation", "Search Quotation...")}
                value={filter.search || ""}
