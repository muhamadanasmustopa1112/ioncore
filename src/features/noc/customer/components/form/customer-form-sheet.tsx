...
export function CustomerFormSheet() {
    ...
    return (
        <Sheet open={customerSheetOpen} onOpenChange={(open) => !open && closeCustomerFormSheet()}>
            <SheetContent className="inset-y-8 lg:end-10 start-auto h-full max-h-[calc(100vh-64px)] gap-0 rounded-lg border p-0 sm:max-w-none lg:w-[700px] flex flex-col [&_[data-slot=sheet-close]]:end-5 [&_[data-slot=sheet-close]]:top-4.5 shadow-2xl bg-white dark:bg-slate-950">
                {/* Header */}
