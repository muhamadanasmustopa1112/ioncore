...
const PPPProfileColumns = () => {
  ...
  return [
  {
    ...
    header: ({ column }) => (
      <DataGridColumnHeader title={t("pppProfile.planName", "Plan Name")} column={column} className="text-foreground font-semibold" />
    ),
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataGridColumnHeader title={t("pppProfile.code", "Code")} column={column} className="text-foreground font-semibold" />
    ),
    cell: ({ row }) => (
      <div className="font-bold text-foreground py-1">
        {row.original.code}
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataGridColumnHeader title={t("pppProfile.profileGroup", "Profile Group")} column={column} className="text-foreground font-semibold" />
    ),
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataGridColumnHeader
        title={t("pppProfile.capitalPrice", "Capital Price")}
        column={column}
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataGridColumnHeader
        title={t("pppProfile.sellPrice", "Sell Price")}
        column={column}
        className="text-foreground font-semibold justify-end"
      />
    ),
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataGridColumnHeader title={t("pppProfile.sharedUser", "Shared User")} column={column} className="text-foreground font-semibold" />
    ),
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataGridColumnHeader title={t("pppProfile.dataOwner", "Data Owner")} column={column} className="text-foreground font-semibold" />
    ),
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataGridColumnHeader title={t("pppProfile.vcrCustomer", "VCR | Customer")} column={column} className="text-foreground font-semibold" />
    ),
    cell: ({ row }) => (
  ...
  },
  {
    id: "actions",
    header: ({ column }) => (
      <div className="text-center font-semibold text-foreground px-2">{t("common.action", "Action")}</div>
    ),
    cell: ({ row }) => (
...
] as ColumnDef<PPPProfileItem>[];
};

export const usePPPProfileColumns = PPPProfileColumns;
