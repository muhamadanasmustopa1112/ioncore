...
const RouterColumns = () => {
  ...
  return [
    {
      ...
      header: ({ column }) => (
        <DataGridColumnHeader title={t("router.pingStatus", "Ping Status")} column={column} className="text-foreground font-semibold" />
      ),
      cell: ({ row }) => (
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataGridColumnHeader title={t("router.routerName", "Router Name")} column={column} className="text-foreground font-semibold" />
      ),
      cell: ({ row }) => (
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataGridColumnHeader title={t("router.ipAddress", "IP Address")} column={column} className="text-foreground font-semibold" />
      ),
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataGridColumnHeader title={t("router.timeZone", "Time Zone")} column={column} className="text-foreground font-semibold" />
      ),
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataGridColumnHeader title={t("router.description", "Description")} column={column} className="text-foreground font-semibold" />
      ),
      cell: ({ row }) => (
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataGridColumnHeader title={t("router.onlineUsers", "Online Users")} column={column} className="text-foreground font-semibold" />
      ),
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataGridColumnHeader title={t("router.lastChecked", "Last Checked")} column={column} className="text-foreground font-semibold" />
      ),
      cell: ({ row }) => (
        <div>
  ...
  ] as ColumnDef<RouterItem>[];
};

export const useRouterColumns = RouterColumns;
