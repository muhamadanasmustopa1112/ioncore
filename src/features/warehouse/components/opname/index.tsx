  ...
  return (
    <div className="relative h-full w-full overflow-hidden px-6 py-3">
      ...
      <Toolbar className="mt-5 items-center">
        <ToolbarHeading><ToolbarTitle className="text-2xl font-extrabold tracking-tight">{t("warehouse.opnameTitle", "Stock Opname")}</ToolbarTitle></ToolbarHeading>
        <ToolbarActions>
          ...
          <Button variant="primary" className="h-11 px-6 font-semibold shadow-md" onClick={() => openOpnameFormSheet("new")}><RiAddLine className="size-5" />{t("warehouse.newOpname", "New Opname")}</Button>
        </ToolbarActions>
      </Toolbar>
