...
export function ActionsCell({ row }: { row: Row<StockOpname> }) {
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent side="bottom" align="end">
          <DropdownMenuItem className="cursor-pointer" onClick={() => { setSelectedOpname(row.original); openOpnameFormSheet("edit"); }}>
            <RiEditLine /> Edit
          </DropdownMenuItem>
          <DropdownMenuItem className="cursor-pointer" onClick={() => { setSelectedOpname(row.original); openOpnameFormSheet("details"); }}>
            <RiEyeLine /> Detail
          </DropdownMenuItem>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>This will permanently delete opname &quot;{row.original.id}&quot;. This action cannot be undone.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
