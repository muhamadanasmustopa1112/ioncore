...
export function ActionsCell({ row }: { row: Row<StockTransfer> }) {
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent side="bottom" align="end">
          <DropdownMenuItem className="cursor-pointer" onClick={() => { setSelectedTransfer(row.original); openTransferFormSheet("edit"); }}>
            <RiEditLine /> Edit
          </DropdownMenuItem>
          <DropdownMenuItem className="cursor-pointer" onClick={() => { setSelectedTransfer(row.original); openTransferFormSheet("details"); }}>
            <RiEyeLine /> Detail
          </DropdownMenuItem>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>This will permanently delete transfer &quot;{row.original.id}&quot;. This action cannot be undone.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
