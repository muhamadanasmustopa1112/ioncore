...
export function ReturnsList() {
  ...
  const table = useReactTable({
    ...
    getRowId: (row: DeviceReturnRecord) => String(row.id),
            ...
            <CardHeading className="py-4">
              <div className="flex items-center gap-2">
                ...
                <div className="relative">
                  ...
                  <Input placeholder={t("warehouse.searchReturns", "Search returns...")} value={filter.search || ""} onChange={(e) => setFilter({ ...filter, search: e.target.value })} className="w-64 ps-9" />
