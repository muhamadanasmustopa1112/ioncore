...
import { EmployeeScrollContentTwoColumns } from "./employee-scroll-content-two-columns";

export function EmployeeDetailsTwoColumns() {
  ...
  return (
    <>
      ...
      {!!id && <EmployeeScrollContentTwoColumns />}
      {!id && (
        <ScrollArea
          className="flex flex-col"
          viewportClassName="[&>div]:h-full [&>div>div]:h-full"
        >
          <EmployeeScrollContentTwoColumns />
        </ScrollArea>
      )}
    </>
  );
