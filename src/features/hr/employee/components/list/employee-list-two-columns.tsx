...
import { EmployeeDetailsTwoColumns } from "../details-two-columns/employee-details-two-columns";
import { EmployeeForm } from "../form/employee-form";
import { ActionsCell } from "./table/data-table-actions-cell";
import { DataTableToolbar } from "./table/data-table-toolbar";

export function EmployeeListTwoColumns() {
    ...
    <>
      ...
      >
        <Card className="overflow-hidden">
          <div className="flex flex-col lg:flex-row items-stretch relative overflow-hidden min-h-[500px]">
            <div className={cn("w-full border-e flex-1")}>
              <CardHeader>
                <CardHeading>
                  <div className="flex items-center gap-2.5">
            ...
            <AnimatePresence>
              {employeeSheetOpen && (
                ...
                >
                  ...
                  {form === "details" && (
                    <div className="flex-1 overflow-auto absolute bottom-0 left-0 right-0 top-0">
                      <EmployeeDetailsTwoColumns />
                    </div>
                  )}
                </motion.div>
              )}
