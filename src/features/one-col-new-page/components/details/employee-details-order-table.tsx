...
import { EmployeeCreateShippingLabelSheet } from "./employee-create-shipping-label-sheet";
import { EmployeeOrderDetailsSheet } from "./employee-order-details-sheet";
import { EmployeeProductInfoSheet } from "./employee-product-info-sheet";
import { EmployeeTrackShippingSheet } from "./employee-track-shipping-sheet";
...
export function EmployeeDetailsOrdersTable({
