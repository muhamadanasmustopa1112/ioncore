      ...
      {alerts && alerts.length > 0 && (
        <div className="space-y-2.5">
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 gap-3.5 ${
            alerts.length > 10 ? "max-h-[380px] overflow-y-auto pr-1.5 scrollbar-thin" : ""
          }`}>
                  ...
                  <div className="flex-1 min-w-0 pt-0.5">
                    <div className="flex items-center gap-2 mb-1">
                      <span className={`text-[10px] font-extrabold uppercase px-1.5 py-0.5 rounded-md border ${
                        alert.severity === "critical" ? "bg-rose-100/50 border-rose-200 text-rose-700 dark:bg-rose-950/50 dark:border-rose-900/40 dark:text-rose-300" :
